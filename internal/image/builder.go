...
const (
	...
	MediaTypeKoPrometheusImagesTar = "application/vnd.ko.layer.prometheus.images.tar.v1"
	MediaTypeKoPrometheusChart = "application/vnd.ko.layer.prometheus.chart.tgz.v1"
	...
	MediaTypeKoKubeletBinary   = "application/vnd.ko.layer.kubelet.binary.v1+tar.gz"
	MediaTypeKoCRIDockerdBinary = "application/vnd.ko.layer.cri-dockerd.binary.v1+tar.gz"
